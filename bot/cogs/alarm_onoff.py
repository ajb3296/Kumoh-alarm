...
class AlarmSet(commands.Cog):
    ...
    @slash_command()
    @option("table", description="알람 소스를 선택하세요", choices=KumohSquarePage.name_list() + ["SE_Board", "Hagsigdang", "faculty_cafeteria", "Purum", "Orum1", "Orum23", "Employment"])
    ...
    @slash_command()
    @option("table", description="알람이 켜져있는지 확인할 소스를 선택하세요", choices=KumohSquarePage.name_list() + ["SE_Board", "Hagsigdang", "faculty_cafeteria", "Purum", "Orum1", "Orum23", "Employment"])
